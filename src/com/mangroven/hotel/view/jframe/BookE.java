 ...
 * @author Athukorala
 */
public class BookE extends javax.swing.JFrame {
    private String rid="R05";
    private ReservationController cntrl;
int yMouse;
int xMouse;

    /**
     * Creates new form BookE
     */
    public BookE() {
        try {
            initComponents();
            ...
            Logger.getLogger(BookE.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
