...
public class EmailAttachmentSender {
     ...
     */
    public void attachment(String email,String path) {
        //System.out.println("eee");
        // SMTP info
        String host = "smtp.gmail.com";
        String port = "587";
        String mailFrom = "tharindu.hotelgdse41@gmail.com";
        String password = "gdse41hotel";

        // message info
        String mailTo = email;
        String subject = "Mangroven Hotel";
        String message = " Mangroven Hotel";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Could not send Email"+ ex.getMessage());
